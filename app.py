...
# Load and preprocess the dataset from local file
...
# Weighted ensemble prediction (based on CV MAE)
...
# Home route to serve the dashboard
@app.route('/')
def home():
...
def predict():
    try:
        ...
        # Convert descriptive inputs to original dataset values
        input_data = {}
